    ...
    public PokemonCatcher() {
        MouseAdapter listener = new MouseAdapter() {
            @Override public void mouseClicked(MouseEvent e) {
                ...
                //forecast and get pokemon from the event component
                ...
                if(pokemon.isCatchable()) {
                    if (pokemon.getID() == 0 || pokemon.getID() == 1 || pokemon.getID() == 2)
                        score++;
                    else if (pokemon.getID() == 64 || pokemon.getID() == 62)
                        score--;
                    pokemon.caught();
        ...
        for(JLabel pokemon:pokemons) { pokemon.addMouseListener(listener); }
