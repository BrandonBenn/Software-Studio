...
public class Pokedex {
    ...
    public void addNewPokemon(int id,String name, int[] speciesValue)
    {
        ...
        PokemonValueData pokeValueArray = new PokemonValueData(speciesValue);
        PokemonSpeciesData newPokemon = new PokemonSpeciesData(id,name,pokeValueArray);
        pokemonSpeciesDataList.add(newPokemon);
        Gson gson = new Gson();
        String jsonString = gson.toJson(pokemonSpeciesDataList);
